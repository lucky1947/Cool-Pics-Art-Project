 ...
 * <#uniqname(s)#> lmchow
 *
 * <#Description#> All member functions for class Triangle are implemented here.
 */
...
Triangle::Triangle(Point pt1, Color color1, Point pt2, Color color2, Point pt3,
    Color color3) {
    vertexOne = pt1;
...
// Write triangle in form v1 v1Color v2 v2Color v3 v3Color
void Triangle::write(ostream& outs) {
    Point outsVertexOne = getVertexOne();
    Point outsVertexTwo = getVertexTwo();
    Point outsVertexThree = getVertexThree();
    Color outsVertexOneColor = getVertexOneColor();
    Color outsVertexTwoColor = getVertexTwoColor();
    Color outsVertexThreeColor = getVertexThreeColor();
    
    outs << outsVertexOne << " " << outsVertexTwo << " " << outsVertexThree <<
        " " << outsVertexOneColor << " " << outsVertexTwoColor << " " <<
        outsVertexThreeColor << endl;
}
